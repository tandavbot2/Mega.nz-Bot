...
async def guess_and_send(input_file, chat_id, message, thumb_path="cache"):
    ...
    if not f_mime or not f_mime.mime:
        ...
        # For gifs
        if re.search(r'\bimage/gif\b', f_mime.mime):
        ...
        # For images
        elif re.search(r'\bimage\b', f_mime.mime):
        ...
        # For videos
        elif re.search(r'\bvideo\b', f_mime.mime):
        ...
        # For audio
        elif re.search(r'\baudio\b', f_mime.mime):
